...
#define DEBUG 1 // Change to 0 to disable debugging output
...
#if DEBUG
#define debug(x...) std::cerr << "[" #x << "] = [" ;__print(x) ;std::cerr << std::endl;
#else
#define debug(x...)
#endif
// Add more functions for different data structures here as needed
